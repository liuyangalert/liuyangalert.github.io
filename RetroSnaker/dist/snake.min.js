(function (global, factory) {
    ...
    (global.SnakeGame = factory());
}(this, (function () { 'use strict';

    class SnakeGame {
        constructor(canvas, { setScore, setMaxScore, }) {
        ...
        circle(ctx, data, s_style, f_style) {
            ctx.save();
            ctx.beginPath();
        ...
        moveByDir(dir) {
            let strageMode = {
                L: () => {
                    this.cx = this.cx - this.cellWidth;
                    this.cy = this.cy;
                },
                T: () => {
                    this.cx = this.cx;
                    this.cy = this.cy - this.cellWidth;
                },
                R: () => {
                    this.cx = this.cx + this.cellWidth;
                    this.cy = this.cy;
